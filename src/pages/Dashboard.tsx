  ...
  return (
    <div>
        ...
        >
          ...
          <Stack width="100%">
            <BoxInCome
              ...
              value={
                authReducer.mDashboard ? authReducer.mDashboard.expenses : 0
              }
            />
          </Stack>
        </Stack>
      ...
      <Box component="div" className="flex justify-center" mb={2}>
        <Stack justifyContent="space-between" className="max-w-md w-full">
          <BoxProgress
            sx={{ height: "100%", mx: 1, mt: 2, borderRadius: 5, boxShadow: 3 }}
            value={
              authReducer.mDashboard.expenses
                ? authReducer.mDashboard.expenses
                : 0
            }
      ...
      <Loading
        open={
          authReducer.isLoadSum ||
          noteReducer.loading ||
          quickNoteReducer.loading
        }
      />
